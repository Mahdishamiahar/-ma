...
body {
  margin:0; font-family:sans-serif; background:var(--bg-dark); color:var(--text-light); display:flex; flex-direction:column; height:100vh; position:relative;
}
.background-text {
  position: fixed; top:50%; left:50%; transform:translate(-50%,-50%);
  font-size:60px; font-weight:bold; color:rgba(255,255,255,0.05); user-select:none; pointer-events:none; z-index:0;
}
...
#modelSelect { background:var(--bg-dark); color:var(--text-light); border:1px solid #30363d; padding:5px; border-radius:5px; font-size:14px; }
